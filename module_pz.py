    ...
    async def przetworz_plik_pz(self, sciezka_obrazu: str):
        ...
        try:
            ...
            prompt = (
                ...
                "2. Tabela towarowa (zwróć SZCZEGÓLNĄ UWAGĘ na nagłówki kolumn tabeli!):\n"
                "   - n: pełna nazwa towaru (dokładnie jak na dokumencie)\n"
                "   - k: kod identyfikacyjny towaru. Przypisuj wartość WEDŁUG ŚCISŁEJ HIERARCHII:\n"
                "       1) Kod kreskowy EAN (EAN-13: 13 cyfr, EAN-8: 8 cyfr) z kolumny opisanej jako 'EAN', 'Kod kreskowy', 'Kod prod.'.\n"
                "       2) Kod CN / Nomenklatura Scalona (zazwyczaj 8 cyfr) lub PKWiU z kolumny 'CN' / 'PKWiU'.\n"
                "       3) Indeks towaru / Symbol / Kod dostawcy z kolumny 'Indeks', 'Kod', 'Symbol', 'Nr katalogowy'.\n"
                "       BEZWZGLĘDNY ZAKAZ: NIGDY nie pobieraj numerów z kolumn takich jak 'Partia', 'Nr partii', 'Seria', "
                "'Batch', 'Lot', 'L/N' ani dat przydatności! Nawet jeśli numer partii ma 8 cyfr, TO NIE JEST KOD EAN ANI CN. "
                "Partię całkowicie ignoruj. Jeśli w wierszu nie ma kodu EAN, weź kod CN lub indeks dostawcy, ale NIGDY numer partii.\n"
